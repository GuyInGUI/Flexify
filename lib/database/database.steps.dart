...
final class Schema52 extends i0.VersionedSchema {
  ...
  late final Shape43 plans = Shape43(
      source: i0.VersionedTable(
        entityName: 'plans',
        withoutRowId: false,
        isStrict: false,
...
class Shape43 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get title =>
      columnsByName['title']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get lastReset =>
      columnsByName['last_reset']! as i1.GeneratedColumn<int>;
}

i1.GeneratedColumn<int> _column_155(String aliasedName) =>
    i1.GeneratedColumn<int>('last_reset', aliasedName, true,
        type: i1.DriftSqlType.int, $customConstraints: 'NULL');
